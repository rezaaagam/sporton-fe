    ...
    <header>
      <div className="flex justify-between gap-10 container mx-auto py-7">
        ...
        <nav className="flex gap-24 font-medium">
          <Link
            href="#" className="relative after:content-[''] after:block after:bg-primary after:rounded-full after:h-0.75 after:w-1/2 after:absolute after:left-1/2 after:-translate-x-1/2 after:translate-y-1">
            Home
          </Link>
