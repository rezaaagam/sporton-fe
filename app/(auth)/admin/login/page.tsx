    ...
    return (
        <main className="bg-[#F7F9FA] w-full min-h-screen flex justify-center items-center">
            <div className="max-w-136 w-full bg-white rounded-xl border-t-4 border-primary py-12 px-18">
                ...
                <p className="opacity-50 text-sm text-center mb-6">Enter your credentials to acces the dashboard</p>

                {errorMessage && (
                    <div className="px-3 py-1 bg-primary-light border border-primary rounded-md text-primary text-sm text-center w-full mb-3">
                        {errorMessage}
                    </div>
                )}
                ...
                <div className="input-group-admin mb-10">
